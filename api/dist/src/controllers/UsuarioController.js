...
export default class UsuarioController {
    ...
    static async listarUsuario(req, res) {
        ...
        const limite = parseInt(req.query.limite) || paginateOptions.limit; // Limite padrão de paginateOptions
        ...
        try {
            ...
            const usuario = await Usuario.paginate(filtros, {
    ...
    static async alterarUsuario(req, res) {
        ...
        for (let key in req.body) {
            ...
            if (key in usuario) {
                ...
                usuario[key] = req.body[key]; // Usando any para contornar o erro do TypeScript
            }
        }
        if (senha) {
