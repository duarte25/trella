...
export default class AuthValidate {
    ...
    static async loginValidate(req: Request, res: Response, next: NextFunction): Promise<Response | void> {
        try {
            const erros: string[] = [];

            const { email, senha } = req.body;
            let userExist: any; // Definimos como 'any' porque não sabemos exatamente o tipo do retorno de 'Usuario.findOne'
